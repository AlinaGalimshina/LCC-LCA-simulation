...
with   r [%]  - inflation rate, d_(nominal ) [%] - discount rate (nominal), RSP [years] - time period of analysis (Reference study period), 〖RSL〗_i  [years] – reference service life or replacement year, n_i  =⌈RSP/〖RSL〗_i ⌉-1 [-] - the number of times the component i has to be replaced during the building’s service life, C_(investment,i)  [CHF] – investment costs of the component i, C_(replacement,i)  [CHF] – replacement costs of the component i, C_(repair,i)  [CHF]  - repair costs of the component i, C_operational  [CHF] – operational costs during the building’s lifecycle, b – the number of the components, C_(demolition,i)  [CHF] – demolition costs of the component i.
